...
const Navigation: React.FC<NavigationProps> = ({ activeTab, setActiveTab }) => {
  ...
  const tabs = [
    { id: Tab.HOME, label: 'হোম' },
    { id: Tab.LIFE_PROTOCOL, label: '১২টি সূত্র' },
    { id: Tab.ATOMIC_HABITS, label: 'অ্যাটমিক হ্যাবিটস' },
    { id: Tab.DEEP_WORK, label: 'ডিপ ওয়ার্ক' },
    { id: Tab.DOPAMINE_DETOX, label: 'ডোপামিন' },
    { id: Tab.DAILY_STOIC, label: 'স্টোয়িসিজম' },
    { id: Tab.DEEP_FOCUS_PROTOCOL, label: 'ডিপ ফোকাস' },
    { id: Tab.MASTER_GUIDE, label: 'মাস্টার গাইড' },
  ];
  ...
  return (
    <nav className="sticky top-0 z-50 bg-dark-900/95 backdrop-blur-md border-b border-slate-800 shadow-lg font-sans">
